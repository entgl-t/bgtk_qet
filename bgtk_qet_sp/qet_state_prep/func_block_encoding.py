...
from bgtk_qet_sp.utils import  bin_to_num, get_gaussian_phases, bin_to_sin,get_sinh_phases, get_tanh_phases, get_x_phases,get_x_2_phases, rescaled_x
from bgtk_qet_sp.utils import plot_result,get_trace_distance,get_degree_polyn_approx,expected_func_polyn,func_max_val
            ...
            for key,val in result.items():
                ...
                print('\n\nInput binary/decimal: ',
                     ...
                     '\nOutput num: ', output_num, '\nExpected num: ', err_coeff*(1/N_tilde_f)*expected_out, '\nRatio: ',(err_coeff*(1/N_tilde_f)*expected_out)/output_num,'Reverse num',
                      num_test)
            exp_state= [i * err_coeff*(1/N_tilde_f)  for i in list_func]
